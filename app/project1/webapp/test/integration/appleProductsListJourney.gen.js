...
sap.ui.define([
    ...
    function journey() {
        QUnit.module("appleProductsListListReport journey");
        ...
        opaTest("Start application", function (Given, When, Then) {
            ...
            Then.onTheappleProductsListGenerated.iSeeThisPage();
        });
        ...
        //     When.onTheappleProductsListGenerated.onFilterBar().iChangeSearchField("Search Term");
        //     When.onTheappleProductsListGenerated.onFilterBar().iExecuteSearch();
        //     Then.onTheappleProductsListGenerated.onTable(defaultTableId).iCheckRows();
        // });
        ...
        opaTest("Navigate to ObjectPage", function (Given, When, Then) {
            ...
            When.onTheappleProductsListGenerated.onFilterBar().iExecuteSearch();
            Then.onTheappleProductsListGenerated.onTable(defaultTableId).iCheckRows();
            When.onTheappleProductsListGenerated.onTable(defaultTableId).iPressRow(0);
            Then.onTheappleProductsObjectPageGenerated.iSeeThisPage();
        });
