...
sap.ui.define([
    ...
    function journey() {
        ...
        opaTest("Start application", function (Given, When, Then) {
            ...
            Then.onTheorderListGenerated.iSeeThisPage();
        });
        ...
        //     When.onTheorderListGenerated.onFilterBar().iChangeSearchField("Search Term");
        //     When.onTheorderListGenerated.onFilterBar().iExecuteSearch();
        //     Then.onTheorderListGenerated.onTable(defaultTableId).iCheckRows();
        //     When.onTheorderListGenerated.onFilterBar().iChangeSearchField(undefined);
        //     Then.onTheorderListGenerated.onFilterBar().iCheckSearchField(undefined);
        // });
        ...
        opaTest("Navigate to ObjectPage", function (Given, When, Then) {
            ...
            When.onTheorderListGenerated.onFilterBar().iExecuteSearch();
            Then.onTheorderListGenerated.onTable(defaultTableId).iCheckRows();
            When.onTheorderListGenerated.onTable(defaultTableId).iPressRow(0);
